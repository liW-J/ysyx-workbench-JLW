...
module ysyx_23060194_IFU(	// @[<stdin>:1066:10]
  ...
  input         io_out_ar_ready,	// @[cpu/src/stage/IFU.scala:29:14]
  input  [31:0] io_out_r_bits_data,	// @[cpu/src/stage/IFU.scala:29:14]
  ...
  output        io_out_r_ready	// @[cpu/src/stage/IFU.scala:29:14]
);

  reg  [1:0]  state;	// @[cpu/src/stage/IFU.scala:59:22]
  reg  [31:0] pcReg;	// @[cpu/src/stage/IFU.scala:36:26]
  reg         resBranch;	// @[cpu/src/stage/IFU.scala:38:28]
  `ifndef SYNTHESIS	// @[cpu/src/stage/IFU.scala:52:9]
    always @(posedge clock) begin	// @[cpu/src/stage/IFU.scala:52:9]
      if ((`PRINTF_COND_) & ~reset) begin	// @[cpu/src/stage/IFU.scala:52:9, :54:9]
        $fwrite(32'h80000002, "NPC-PC=%x\n", pcReg);	// @[cpu/src/stage/IFU.scala:36:26, :52:9]
        $fwrite(32'h80000002, "NPC-INST=%x\n", io_out_r_bits_data);	// @[cpu/src/stage/IFU.scala:52:9, :53:9]
        $fwrite(32'h80000002, "isIFU=%x\n", ~(|state));	// @[cpu/src/stage/IFU.scala:52:9, :54:9, :59:22, :60:36]
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  wire        _state_T_6 = state == 2'h1;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22, :60:36]
  wire        _state_T_8 = state == 2'h2;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22, :60:36]
  wire        _io_out_r_ready_output = (|state) & _state_T_6;	// @[cpu/src/stage/IFU.scala:59:22, :60:36, :68:17, :71:23]
  ...
  always @(posedge clock) begin	// @[<stdin>:1067:11]
    if (reset) begin	// @[<stdin>:1067:11]
      pcReg <= 32'h20000000;	// @[cpu/src/stage/IFU.scala:36:26]
      state <= 2'h0;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22]
    end
      ...
      if (_state_T_8)	// @[cpu/src/stage/IFU.scala:60:36]
        state <= {~(|state), 1'h0};	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22, :60:36, :64:26]
      else if (_state_T_6) begin	// @[cpu/src/stage/IFU.scala:60:36]
        if (_io_out_r_ready_output)	// @[cpu/src/stage/IFU.scala:68:17, :71:23]
          state <= 2'h2;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22]
        else	// @[cpu/src/stage/IFU.scala:68:17, :71:23]
          state <= 2'h1;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22]
      end
      else	// @[cpu/src/stage/IFU.scala:60:36]
        state <= {1'h0, ~(|state) & io_out_ar_ready};	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22, :60:36, :62:20]
    end
    if (_io_out_r_ready_output)	// @[cpu/src/stage/IFU.scala:68:17, :71:23]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:1066:10]
    ...
    initial begin	// @[<stdin>:1066:10]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:1066:10]
        ...
        state = _RANDOM[1'h1][2:1];	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:38:28, :59:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_isIFU = ~(|state);	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:59:22, :60:36]
  assign io_status = {30'h0, state};	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:40:21, :59:22, :87:13]
  assign io_out_ar_valid = ~(|state) | ~(_state_T_6 | _state_T_8);	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:31:19, :32:19, :59:22, :60:36, :68:17, :70:23, :75:23, :80:23]
  assign io_out_ar_bits_addr = pcReg;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:36:26]
  assign io_out_r_ready = _io_out_r_ready_output;	// @[<stdin>:1066:10, cpu/src/stage/IFU.scala:68:17, :71:23]
endmodule

module ysyx_23060194_LSU(	// @[<stdin>:1167:10]
  input         clock,	// @[<stdin>:1168:11]
                reset,	// @[<stdin>:1169:11]
  ...
  output [31:0] io_out_aw_bits_addr,	// @[cpu/src/stage/LSU.scala:26:14]
  output        io_out_w_valid,	// @[cpu/src/stage/LSU.scala:26:14]
  output [31:0] io_out_w_bits_data	// @[cpu/src/stage/LSU.scala:26:14]
);

  reg [1:0] state;	// @[cpu/src/stage/LSU.scala:62:22]
  always @(posedge clock) begin	// @[<stdin>:1168:11]
    if (reset)	// @[<stdin>:1168:11]
      ...
      state <= {state == 2'h0 & io_in_aw_valid, 1'h0};	// @[<stdin>:1167:10, cpu/src/stage/LSU.scala:26:14, :62:22, :63:36, :64:24, :65:24]
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:1167:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:1167:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:1167:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:0];	// @[<stdin>:1167:10]
    initial begin	// @[<stdin>:1167:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:1167:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:1167:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:1167:10]
        _RANDOM[/*Zero width*/ 1'b0] = `RANDOM;	// @[<stdin>:1167:10]
        state = _RANDOM[/*Zero width*/ 1'b0][1:0];	// @[<stdin>:1167:10, cpu/src/stage/LSU.scala:62:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:1167:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:1167:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
  assign io_res = io_out_r_bits_data;	// @[<stdin>:1167:10]
  assign io_isLSU = io_in_aw_valid;	// @[<stdin>:1167:10]
  assign io_status = {30'h0, state};	// @[<stdin>:1167:10, cpu/src/stage/LSU.scala:62:22, :68:13]
  assign io_out_ar_valid = io_isLoad;	// @[<stdin>:1167:10]
  assign io_out_ar_bits_addr = io_addr;	// @[<stdin>:1167:10]
  assign io_out_ar_bits_len = io_len;	// @[<stdin>:1167:10]
  assign io_out_aw_valid = io_isStore;	// @[<stdin>:1167:10]
  assign io_out_aw_bits_addr = io_addr;	// @[<stdin>:1167:10]
  assign io_out_w_valid = io_isStore;	// @[<stdin>:1167:10]
  assign io_out_w_bits_data = io_in_w_bits_data;	// @[<stdin>:1167:10]
endmodule
...
module AXI4SRAM(	// @[<stdin>:1245:10]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[<stdin>:1245:10]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[<stdin>:1245:10]
      `FIRRTL_BEFORE_INITIAL	// @[<stdin>:1245:10]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:4];	// @[<stdin>:1245:10]
    initial begin	// @[<stdin>:1245:10]
      `ifdef INIT_RANDOM_PROLOG_	// @[<stdin>:1245:10]
        `INIT_RANDOM_PROLOG_	// @[<stdin>:1245:10]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[<stdin>:1245:10]
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          _RANDOM[i] = `RANDOM;	// @[<stdin>:1245:10]
        end	// @[<stdin>:1245:10]
        dataSRAM_io_len_r = _RANDOM[3'h0];	// @[<stdin>:1245:10, cpu/src/bus/AXI4SRAM.scala:33:35]
        dataSRAM_io_wdata_r = _RANDOM[3'h1];	// @[<stdin>:1245:10, cpu/src/bus/AXI4SRAM.scala:34:35]
        dataSRAM_io_addr_r = _RANDOM[3'h2];	// @[<stdin>:1245:10, cpu/src/bus/AXI4SRAM.scala:35:35]
        dataSRAM_io_isLoad_r = _RANDOM[3'h3][0];	// @[<stdin>:1245:10, cpu/src/bus/AXI4SRAM.scala:36:35]
        dataSRAM_io_isStore_r = _RANDOM[3'h3][1];	// @[<stdin>:1245:10, cpu/src/bus/AXI4SRAM.scala:36:35, :37:35]
        instSRAM_io_pc_r = {_RANDOM[3'h3][31:2], _RANDOM[3'h4][1:0]};	// @[<stdin>:1245:10, cpu/src/bus/AXI4SRAM.scala:36:35, :38:35]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[<stdin>:1245:10]
      `FIRRTL_AFTER_INITIAL	// @[<stdin>:1245:10]
    `endif // FIRRTL_AFTER_INITIAL
  `endif // ENABLE_INITIAL_REG_
...
module AXI4Arbiter(	// @[<stdin>:1300:10]
  ...
  input         io_in2ifu_r_ready,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
                io_in2lsu_ar_valid,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
  ...
  input  [31:0] io_in2lsu_aw_bits_addr,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
  input         io_in2lsu_w_valid,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
  ...
  output        io_out_r_ready,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
                io_out_aw_valid,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
  output [31:0] io_out_aw_bits_addr,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
  output        io_out_w_valid,	// @[cpu/src/bus/AXI4Arbiter.scala:22:14]
  ...
  assign io_in2ifu_r_bits_data = io_resIFU;	// @[<stdin>:1300:10]
  assign io_in2lsu_r_bits_data = io_resLSU;	// @[<stdin>:1300:10]
  assign io_out_ar_valid = _GEN ? io_in2ifu_ar_valid : _GEN_0 & io_in2lsu_ar_valid;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:42:16, :44:23, :53:23]
  assign io_out_ar_bits_addr =
    _GEN ? io_in2ifu_ar_bits_addr : _GEN_0 ? io_in2lsu_ar_bits_addr : 32'h0;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:22:14, :42:16, :48:23, :57:23]
  assign io_out_ar_bits_len = _GEN_1 ? 32'h0 : io_in2lsu_ar_bits_len;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:22:14, :42:16, :48:23]
  assign io_out_r_ready = _GEN ? io_in2ifu_r_ready : _GEN_0;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:42:16, :45:23]
  assign io_out_aw_valid = ~_GEN & _GEN_0 & io_in2lsu_aw_valid;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:42:16, :46:23, :47:23]
  assign io_out_aw_bits_addr = _GEN_1 ? 32'h0 : io_in2lsu_aw_bits_addr;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:22:14, :42:16, :48:23, :49:23]
  assign io_out_w_valid = ~_GEN & _GEN_0 & io_in2lsu_w_valid;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:42:16, :46:23]
  assign io_out_w_bits_data = _GEN_1 ? 32'h0 : io_in2lsu_w_bits_data;	// @[<stdin>:1300:10, cpu/src/bus/AXI4Arbiter.scala:22:14, :42:16, :48:23, :50:23]
endmodule

module ysyx_23060194(	// @[<stdin>:1424:10]
  input         clock,	// @[<stdin>:1425:11]
                reset,	// @[<stdin>:1426:11]
                io_master_awready,	// @[cpu/src/TOP.scala:30:14]
                io_master_wready,	// @[cpu/src/TOP.scala:30:14]
                io_master_bvalid,	// @[cpu/src/TOP.scala:30:14]
  input  [1:0]  io_master_bresp,	// @[cpu/src/TOP.scala:30:14]
  input  [3:0]  io_master_bid,	// @[cpu/src/TOP.scala:30:14]
  input         io_master_arready,	// @[cpu/src/TOP.scala:30:14]
                io_master_rvalid,	// @[cpu/src/TOP.scala:30:14]
  input  [1:0]  io_master_rresp,	// @[cpu/src/TOP.scala:30:14]
  input  [63:0] io_master_rdata,	// @[cpu/src/TOP.scala:30:14]
  input         io_master_rlast,	// @[cpu/src/TOP.scala:30:14]
  input  [3:0]  io_master_rid,	// @[cpu/src/TOP.scala:30:14]
  input         io_slave_awvalid,	// @[cpu/src/TOP.scala:30:14]
  input  [31:0] io_slave_awaddr,	// @[cpu/src/TOP.scala:30:14]
  input  [3:0]  io_slave_awid,	// @[cpu/src/TOP.scala:30:14]
  input  [7:0]  io_slave_awlen,	// @[cpu/src/TOP.scala:30:14]
  input  [2:0]  io_slave_awsize,	// @[cpu/src/TOP.scala:30:14]
  input  [1:0]  io_slave_awburst,	// @[cpu/src/TOP.scala:30:14]
  input         io_slave_wvalid,	// @[cpu/src/TOP.scala:30:14]
  input  [63:0] io_slave_wdata,	// @[cpu/src/TOP.scala:30:14]
  input  [7:0]  io_slave_wstrb,	// @[cpu/src/TOP.scala:30:14]
  input         io_slave_wlast,	// @[cpu/src/TOP.scala:30:14]
                io_slave_bready,	// @[cpu/src/TOP.scala:30:14]
                io_slave_arvalid,	// @[cpu/src/TOP.scala:30:14]
  input  [31:0] io_slave_araddr,	// @[cpu/src/TOP.scala:30:14]
  input  [3:0]  io_slave_arid,	// @[cpu/src/TOP.scala:30:14]
  input  [7:0]  io_slave_arlen,	// @[cpu/src/TOP.scala:30:14]
  input  [2:0]  io_slave_arsize,	// @[cpu/src/TOP.scala:30:14]
  input  [1:0]  io_slave_arburst,	// @[cpu/src/TOP.scala:30:14]
  input         io_slave_rready,	// @[cpu/src/TOP.scala:30:14]
                io_interrupt,	// @[cpu/src/TOP.scala:30:14]
  output        io_master_awvalid,	// @[cpu/src/TOP.scala:30:14]
  output [31:0] io_master_awaddr,	// @[cpu/src/TOP.scala:30:14]
  output [3:0]  io_master_awid,	// @[cpu/src/TOP.scala:30:14]
  output [7:0]  io_master_awlen,	// @[cpu/src/TOP.scala:30:14]
  output [2:0]  io_master_awsize,	// @[cpu/src/TOP.scala:30:14]
  output [1:0]  io_master_awburst,	// @[cpu/src/TOP.scala:30:14]
  output        io_master_wvalid,	// @[cpu/src/TOP.scala:30:14]
  output [63:0] io_master_wdata,	// @[cpu/src/TOP.scala:30:14]
  output [7:0]  io_master_wstrb,	// @[cpu/src/TOP.scala:30:14]
  output        io_master_wlast,	// @[cpu/src/TOP.scala:30:14]
                io_master_bready,	// @[cpu/src/TOP.scala:30:14]
                io_master_arvalid,	// @[cpu/src/TOP.scala:30:14]
  output [31:0] io_master_araddr,	// @[cpu/src/TOP.scala:30:14]
  output [3:0]  io_master_arid,	// @[cpu/src/TOP.scala:30:14]
  output [7:0]  io_master_arlen,	// @[cpu/src/TOP.scala:30:14]
  output [2:0]  io_master_arsize,	// @[cpu/src/TOP.scala:30:14]
  output [1:0]  io_master_arburst,	// @[cpu/src/TOP.scala:30:14]
  output        io_master_rready,	// @[cpu/src/TOP.scala:30:14]
                io_slave_awready,	// @[cpu/src/TOP.scala:30:14]
                io_slave_wready,	// @[cpu/src/TOP.scala:30:14]
                io_slave_bvalid,	// @[cpu/src/TOP.scala:30:14]
  output [1:0]  io_slave_bresp,	// @[cpu/src/TOP.scala:30:14]
  output [3:0]  io_slave_bid,	// @[cpu/src/TOP.scala:30:14]
  output        io_slave_arready,	// @[cpu/src/TOP.scala:30:14]
                io_slave_rvalid,	// @[cpu/src/TOP.scala:30:14]
  output [1:0]  io_slave_rresp,	// @[cpu/src/TOP.scala:30:14]
  output [63:0] io_slave_rdata,	// @[cpu/src/TOP.scala:30:14]
  output        io_slave_rlast,	// @[cpu/src/TOP.scala:30:14]
  output [3:0]  io_slave_rid	// @[cpu/src/TOP.scala:30:14]
);

  wire [31:0] _arbiter_io_in2ifu_r_bits_data;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _arbiter_io_in2lsu_r_bits_data;	// @[cpu/src/TOP.scala:44:26]
  wire        _arbiter_io_out_ar_valid;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _arbiter_io_out_ar_bits_addr;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _arbiter_io_out_ar_bits_len;	// @[cpu/src/TOP.scala:44:26]
  wire        _arbiter_io_out_aw_valid;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _arbiter_io_out_w_bits_data;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _sram_io_resIFU;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _sram_io_resLSU;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _lsu_io_res;	// @[cpu/src/TOP.scala:42:26]
  wire        _lsu_io_isLSU;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _lsu_io_status;	// @[cpu/src/TOP.scala:42:26]
  wire        _lsu_io_out_ar_valid;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _lsu_io_out_ar_bits_addr;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _lsu_io_out_ar_bits_len;	// @[cpu/src/TOP.scala:42:26]
  wire        _lsu_io_out_aw_valid;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _lsu_io_out_aw_bits_addr;	// @[cpu/src/TOP.scala:42:26]
  wire        _lsu_io_out_w_valid;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _lsu_io_out_w_bits_data;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _ifu_io_pc;	// @[cpu/src/TOP.scala:41:26]
  wire [31:0] _ifu_io_inst;	// @[cpu/src/TOP.scala:41:26]
  wire        _ifu_io_isIFU;	// @[cpu/src/TOP.scala:41:26]
  wire [31:0] _ifu_io_status;	// @[cpu/src/TOP.scala:41:26]
  wire        _ifu_io_out_ar_valid;	// @[cpu/src/TOP.scala:41:26]
  wire [31:0] _ifu_io_out_ar_bits_addr;	// @[cpu/src/TOP.scala:41:26]
  wire        _ifu_io_out_r_ready;	// @[cpu/src/TOP.scala:41:26]
  wire        _controller_io_bundleEXControl_isALUSrc;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleEXControl_isJAL;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleEXControl_isBranch;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleEXControl_isUnsigned;	// @[cpu/src/TOP.scala:38:26]
  wire [3:0]  _controller_io_bundleEXControl_aluType;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_isJump;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_isBranch;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_writeEnable;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_isLoad;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_isStore;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_isUnsigned;	// @[cpu/src/TOP.scala:38:26]
  wire        _controller_io_bundleControlOut_isContext;	// @[cpu/src/TOP.scala:38:26]
  wire [3:0]  _controller_io_bundleControlOut_csrType;	// @[cpu/src/TOP.scala:38:26]
  wire [3:0]  _controller_io_bundleControlOut_lsuType;	// @[cpu/src/TOP.scala:38:26]
  wire        _exu_io_resBranch;	// @[cpu/src/TOP.scala:37:26]
  wire [31:0] _exu_io_res;	// @[cpu/src/TOP.scala:37:26]
  wire        _exu_io_out_aw_valid;	// @[cpu/src/TOP.scala:37:26]
  wire [31:0] _exu_io_out_w_bits_data;	// @[cpu/src/TOP.scala:37:26]
  wire [31:0] _wbu_io_dataRead1;	// @[cpu/src/TOP.scala:36:26]
  wire [31:0] _wbu_io_dataRead2;	// @[cpu/src/TOP.scala:36:26]
  wire [31:0] _wbu_io_csrData;	// @[cpu/src/TOP.scala:36:26]
  wire [31:0] _wbu_io_resCSR;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isALUSrc;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isJump;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isBranch;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isJAL;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_writeEnable;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isLoad;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isStore;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isUnsigned;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_BundleControl_isContext;	// @[cpu/src/TOP.scala:35:26]
  wire [3:0]  _idu_io_BundleControl_csrType;	// @[cpu/src/TOP.scala:35:26]
  wire [3:0]  _idu_io_BundleControl_lsuType;	// @[cpu/src/TOP.scala:35:26]
  wire [3:0]  _idu_io_BundleControl_aluType;	// @[cpu/src/TOP.scala:35:26]
  wire [4:0]  _idu_io_bundleReg_rs1;	// @[cpu/src/TOP.scala:35:26]
  wire [4:0]  _idu_io_bundleReg_rs2;	// @[cpu/src/TOP.scala:35:26]
  wire [4:0]  _idu_io_bundleReg_rd;	// @[cpu/src/TOP.scala:35:26]
  wire [31:0] _idu_io_imm;	// @[cpu/src/TOP.scala:35:26]
  wire        _idu_io_isEbreak;	// @[cpu/src/TOP.scala:35:26]
  `ifndef SYNTHESIS	// @[cpu/src/TOP.scala:131:9]
    always @(posedge clock) begin	// @[cpu/src/TOP.scala:131:9]
      if ((`PRINTF_COND_) & ~reset) begin	// @[cpu/src/TOP.scala:131:9, :132:9]
        $fwrite(32'h80000002, "ifu.io.out.ar.ready=%d\n", io_master_arready);	// @[cpu/src/TOP.scala:131:9]
        $fwrite(32'h80000002, "ifu.io.out.r.bits.data=%d\n",
                _arbiter_io_in2ifu_r_bits_data);	// @[cpu/src/TOP.scala:44:26, :131:9, :132:9]
      end
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ysyx_23060194_IDU idu (	// @[cpu/src/TOP.scala:35:26]
    .io_inst                      (_ifu_io_inst),	// @[cpu/src/TOP.scala:41:26]
  ...
  ysyx_23060194_WBU wbu (	// @[cpu/src/TOP.scala:36:26]
    .clock            (clock),
    .io_writeEnable   (_controller_io_bundleControlOut_writeEnable),	// @[cpu/src/TOP.scala:38:26]
    .io_isJump        (_controller_io_bundleControlOut_isJump),	// @[cpu/src/TOP.scala:38:26]
    .io_isLoad        (_controller_io_bundleControlOut_isLoad),	// @[cpu/src/TOP.scala:38:26]
    .io_isUnsigned    (_controller_io_bundleControlOut_isUnsigned),	// @[cpu/src/TOP.scala:38:26]
    .io_isContext     (_controller_io_bundleControlOut_isContext),	// @[cpu/src/TOP.scala:38:26]
    .io_imm           (_idu_io_imm),	// @[cpu/src/TOP.scala:35:26]
    .io_csrType       (_controller_io_bundleControlOut_csrType),	// @[cpu/src/TOP.scala:38:26]
    .io_lsuType       (_controller_io_bundleControlOut_lsuType),	// @[cpu/src/TOP.scala:38:26]
    .io_pc            (_ifu_io_pc),	// @[cpu/src/TOP.scala:41:26]
    .io_dataWrite     (_lsu_io_res),	// @[cpu/src/TOP.scala:42:26]
    .io_bundleReg_rs1 (_idu_io_bundleReg_rs1),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleReg_rs2 (_idu_io_bundleReg_rs2),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleReg_rd  (_idu_io_bundleReg_rd),	// @[cpu/src/TOP.scala:35:26]
    .io_lsuStatus     (_lsu_io_status),	// @[cpu/src/TOP.scala:42:26]
    .io_dataRead1     (_wbu_io_dataRead1),
    .io_dataRead2     (_wbu_io_dataRead2),
    .io_csrData       (_wbu_io_csrData),
    .io_resCSR        (_wbu_io_resCSR)
  );
  ysyx_23060194_EXU exu (	// @[cpu/src/TOP.scala:37:26]
    .io_bundleEXControl_isALUSrc   (_controller_io_bundleEXControl_isALUSrc),	// @[cpu/src/TOP.scala:38:26]
    .io_bundleEXControl_isJAL      (_controller_io_bundleEXControl_isJAL),	// @[cpu/src/TOP.scala:38:26]
    .io_bundleEXControl_isBranch   (_controller_io_bundleEXControl_isBranch),	// @[cpu/src/TOP.scala:38:26]
    .io_bundleEXControl_isUnsigned (_controller_io_bundleEXControl_isUnsigned),	// @[cpu/src/TOP.scala:38:26]
    .io_bundleEXControl_aluType    (_controller_io_bundleEXControl_aluType),	// @[cpu/src/TOP.scala:38:26]
    .io_dataRead1                  (_wbu_io_dataRead1),	// @[cpu/src/TOP.scala:36:26]
    .io_dataRead2                  (_wbu_io_dataRead2),	// @[cpu/src/TOP.scala:36:26]
    .io_csrData                    (_wbu_io_csrData),	// @[cpu/src/TOP.scala:36:26]
    .io_imm                        (_idu_io_imm),	// @[cpu/src/TOP.scala:35:26]
    .io_pc                         (_ifu_io_pc),	// @[cpu/src/TOP.scala:41:26]
    .io_ifuStatus                  (_ifu_io_status),	// @[cpu/src/TOP.scala:41:26]
    .io_resBranch                  (_exu_io_resBranch),
    .io_res                        (_exu_io_res),
    .io_out_aw_valid               (_exu_io_out_aw_valid),
    .io_out_w_bits_data            (_exu_io_out_w_bits_data)
  );
  Controller controller (	// @[cpu/src/TOP.scala:38:26]
    .io_bundleControlIn_isALUSrc     (_idu_io_BundleControl_isALUSrc),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isJump       (_idu_io_BundleControl_isJump),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isBranch     (_idu_io_BundleControl_isBranch),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isJAL        (_idu_io_BundleControl_isJAL),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_writeEnable  (_idu_io_BundleControl_writeEnable),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isLoad       (_idu_io_BundleControl_isLoad),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isStore      (_idu_io_BundleControl_isStore),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isUnsigned   (_idu_io_BundleControl_isUnsigned),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_isContext    (_idu_io_BundleControl_isContext),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_csrType      (_idu_io_BundleControl_csrType),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_lsuType      (_idu_io_BundleControl_lsuType),	// @[cpu/src/TOP.scala:35:26]
    .io_bundleControlIn_aluType      (_idu_io_BundleControl_aluType),	// @[cpu/src/TOP.scala:35:26]
  ...
  Trap trap (	// @[cpu/src/TOP.scala:39:26]
    .clock    (clock),
    .reset    (reset),
    .isEbreak (_idu_io_isEbreak)	// @[cpu/src/TOP.scala:35:26]
  );
  GetPC getPC (	// @[cpu/src/TOP.scala:40:26]
    .clock (clock),
    .reset (reset),
    .pc    (_ifu_io_pc)	// @[cpu/src/TOP.scala:41:26]
  );
  ysyx_23060194_IFU ifu (	// @[cpu/src/TOP.scala:41:26]
    .clock               (clock),
    .reset               (reset),
    .io_isJump           (_controller_io_bundleControlOut_isJump),	// @[cpu/src/TOP.scala:38:26]
    .io_isBranch         (_controller_io_bundleControlOut_isBranch),	// @[cpu/src/TOP.scala:38:26]
    .io_resBranch        (_exu_io_resBranch),	// @[cpu/src/TOP.scala:37:26]
    .io_addrTarget       (_lsu_io_res),	// @[cpu/src/TOP.scala:42:26]
    .io_csrType          (_controller_io_bundleControlOut_csrType),	// @[cpu/src/TOP.scala:38:26]
    .io_resCSR           (_wbu_io_resCSR),	// @[cpu/src/TOP.scala:36:26]
    .io_lsuStatus        (_lsu_io_status),	// @[cpu/src/TOP.scala:42:26]
    .io_out_ar_ready     (io_master_arready),
    .io_out_r_bits_data  (_arbiter_io_in2ifu_r_bits_data),	// @[cpu/src/TOP.scala:44:26]
    .io_pc               (_ifu_io_pc),
    ...
    .io_out_r_ready      (_ifu_io_out_r_ready)
  );
  ysyx_23060194_LSU lsu (	// @[cpu/src/TOP.scala:42:26]
    .clock               (clock),
    .reset               (reset),
    .io_isLoad           (_controller_io_bundleControlOut_isLoad),	// @[cpu/src/TOP.scala:38:26]
    .io_isStore          (_controller_io_bundleControlOut_isStore),	// @[cpu/src/TOP.scala:38:26]
    .io_addr             (_exu_io_res),	// @[cpu/src/TOP.scala:37:26]
    .io_len              ({28'h0, _controller_io_bundleControlOut_lsuType}),	// @[cpu/src/TOP.scala:38:26, :57:18]
    .io_in_aw_valid      (_exu_io_out_aw_valid),	// @[cpu/src/TOP.scala:37:26]
    .io_in_w_bits_data   (_exu_io_out_w_bits_data),	// @[cpu/src/TOP.scala:37:26]
    .io_out_r_bits_data  (_arbiter_io_in2lsu_r_bits_data),	// @[cpu/src/TOP.scala:44:26]
    .io_res              (_lsu_io_res),
    ...
    .io_out_aw_bits_addr (_lsu_io_out_aw_bits_addr),
    .io_out_w_valid      (_lsu_io_out_w_valid),
    .io_out_w_bits_data  (_lsu_io_out_w_bits_data)
  );
  AXI4SRAM sram (	// @[cpu/src/TOP.scala:43:26]
    .clock              (clock),
    .io_in_ar_valid     (_arbiter_io_out_ar_valid),	// @[cpu/src/TOP.scala:44:26]
    .io_in_ar_bits_addr (_arbiter_io_out_ar_bits_addr),	// @[cpu/src/TOP.scala:44:26]
    .io_in_ar_bits_len  (_arbiter_io_out_ar_bits_len),	// @[cpu/src/TOP.scala:44:26]
    .io_in_aw_valid     (_arbiter_io_out_aw_valid),	// @[cpu/src/TOP.scala:44:26]
    .io_in_w_bits_data  (_arbiter_io_out_w_bits_data),	// @[cpu/src/TOP.scala:44:26]
    .io_isIFU           (_ifu_io_isIFU),	// @[cpu/src/TOP.scala:41:26]
    .io_isLSU           (_lsu_io_isLSU),	// @[cpu/src/TOP.scala:42:26]
    .io_resIFU          (_sram_io_resIFU),
    .io_resLSU          (_sram_io_resLSU)
  );
  AXI4Arbiter arbiter (	// @[cpu/src/TOP.scala:44:26]
    .io_in2ifu_ar_valid     (_ifu_io_out_ar_valid),	// @[cpu/src/TOP.scala:41:26]
    .io_in2ifu_ar_bits_addr (_ifu_io_out_ar_bits_addr),	// @[cpu/src/TOP.scala:41:26]
    .io_in2ifu_r_ready      (_ifu_io_out_r_ready),	// @[cpu/src/TOP.scala:41:26]
    .io_in2lsu_ar_valid     (_lsu_io_out_ar_valid),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_ar_bits_addr (_lsu_io_out_ar_bits_addr),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_ar_bits_len  (_lsu_io_out_ar_bits_len),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_aw_valid     (_lsu_io_out_aw_valid),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_aw_bits_addr (_lsu_io_out_aw_bits_addr),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_w_valid      (_lsu_io_out_w_valid),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_w_bits_data  (_lsu_io_out_w_bits_data),	// @[cpu/src/TOP.scala:42:26]
    .io_isIFU               (_ifu_io_isIFU),	// @[cpu/src/TOP.scala:41:26]
    .io_isLSU               (_lsu_io_isLSU),	// @[cpu/src/TOP.scala:42:26]
    .io_resIFU              (_sram_io_resIFU),	// @[cpu/src/TOP.scala:43:26]
    .io_resLSU              (_sram_io_resLSU),	// @[cpu/src/TOP.scala:43:26]
    ...
    .io_out_aw_bits_addr    (io_master_awaddr),
    .io_out_w_valid         (io_master_wvalid),
    .io_out_w_bits_data     (_arbiter_io_out_w_bits_data)
  );
  assign io_master_awvalid = _arbiter_io_out_aw_valid;	// @[<stdin>:1424:10, cpu/src/TOP.scala:44:26]
  assign io_master_awid = 4'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:32:13]
  assign io_master_awsize = 3'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:32:13]
  assign io_master_awburst = 2'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_master_wdata = {32'h0, _arbiter_io_out_w_bits_data};	// @[<stdin>:1424:10, cpu/src/TOP.scala:44:26, :127:19]
  assign io_master_wstrb = 8'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:32:13]
  assign io_master_wlast = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_master_bready = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_master_arvalid = _arbiter_io_out_ar_valid;	// @[<stdin>:1424:10, cpu/src/TOP.scala:44:26]
  assign io_master_araddr = _arbiter_io_out_ar_bits_addr;	// @[<stdin>:1424:10, cpu/src/TOP.scala:44:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:32:13]
  assign io_master_arsize = 3'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:32:13]
  assign io_master_arburst = 2'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_wready = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:33:13]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
  assign io_slave_rid = 4'h0;	// @[<stdin>:1424:10, cpu/src/TOP.scala:37:26, :41:26, :42:26, :43:26, :44:26]
endmodule
