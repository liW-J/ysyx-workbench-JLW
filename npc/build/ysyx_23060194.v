...
module ysyx_23060194(	// @[<stdin>:1412:10]
  ...
  wire [31:0] _arbiter_io_in2ifu_r_bits_data;	// @[cpu/src/TOP.scala:45:26]
  wire [31:0] _arbiter_io_in2lsu_r_bits_data;	// @[cpu/src/TOP.scala:45:26]
  wire        _arbiter_io_out_ar_valid;	// @[cpu/src/TOP.scala:45:26]
  wire [31:0] _arbiter_io_out_ar_bits_addr;	// @[cpu/src/TOP.scala:45:26]
  wire [31:0] _arbiter_io_out_ar_bits_len;	// @[cpu/src/TOP.scala:45:26]
  wire        _arbiter_io_out_aw_valid;	// @[cpu/src/TOP.scala:45:26]
  wire [31:0] _arbiter_io_out_w_bits_data;	// @[cpu/src/TOP.scala:45:26]
  wire [31:0] _sram_io_resIFU;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _sram_io_resLSU;	// @[cpu/src/TOP.scala:44:26]
  wire [31:0] _lsu_io_res;	// @[cpu/src/TOP.scala:43:26]
  wire        _lsu_io_isLSU;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _lsu_io_status;	// @[cpu/src/TOP.scala:43:26]
  wire        _lsu_io_out_ar_valid;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _lsu_io_out_ar_bits_addr;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _lsu_io_out_ar_bits_len;	// @[cpu/src/TOP.scala:43:26]
  wire        _lsu_io_out_aw_valid;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _lsu_io_out_w_bits_data;	// @[cpu/src/TOP.scala:43:26]
  wire [31:0] _ifu_io_pc;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _ifu_io_inst;	// @[cpu/src/TOP.scala:42:26]
  wire        _ifu_io_isIFU;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _ifu_io_status;	// @[cpu/src/TOP.scala:42:26]
  wire        _ifu_io_out_ar_valid;	// @[cpu/src/TOP.scala:42:26]
  wire [31:0] _ifu_io_out_ar_bits_addr;	// @[cpu/src/TOP.scala:42:26]
  wire        _controller_io_bundleEXControl_isALUSrc;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleEXControl_isJAL;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleEXControl_isBranch;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleEXControl_isUnsigned;	// @[cpu/src/TOP.scala:39:26]
  wire [3:0]  _controller_io_bundleEXControl_aluType;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_isJump;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_isBranch;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_writeEnable;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_isLoad;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_isStore;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_isUnsigned;	// @[cpu/src/TOP.scala:39:26]
  wire        _controller_io_bundleControlOut_isContext;	// @[cpu/src/TOP.scala:39:26]
  wire [3:0]  _controller_io_bundleControlOut_csrType;	// @[cpu/src/TOP.scala:39:26]
  wire [3:0]  _controller_io_bundleControlOut_lsuType;	// @[cpu/src/TOP.scala:39:26]
  wire        _exu_io_resBranch;	// @[cpu/src/TOP.scala:38:26]
  wire [31:0] _exu_io_res;	// @[cpu/src/TOP.scala:38:26]
  wire        _exu_io_out_aw_valid;	// @[cpu/src/TOP.scala:38:26]
  wire [31:0] _exu_io_out_w_bits_data;	// @[cpu/src/TOP.scala:38:26]
  wire [31:0] _wbu_io_dataRead1;	// @[cpu/src/TOP.scala:37:26]
  wire [31:0] _wbu_io_dataRead2;	// @[cpu/src/TOP.scala:37:26]
  wire [31:0] _wbu_io_csrData;	// @[cpu/src/TOP.scala:37:26]
  wire [31:0] _wbu_io_resCSR;	// @[cpu/src/TOP.scala:37:26]
  wire        _idu_io_BundleControl_isALUSrc;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isJump;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isBranch;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isJAL;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_writeEnable;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isLoad;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isStore;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isUnsigned;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_BundleControl_isContext;	// @[cpu/src/TOP.scala:36:26]
  wire [3:0]  _idu_io_BundleControl_csrType;	// @[cpu/src/TOP.scala:36:26]
  wire [3:0]  _idu_io_BundleControl_lsuType;	// @[cpu/src/TOP.scala:36:26]
  wire [3:0]  _idu_io_BundleControl_aluType;	// @[cpu/src/TOP.scala:36:26]
  wire [4:0]  _idu_io_bundleReg_rs1;	// @[cpu/src/TOP.scala:36:26]
  wire [4:0]  _idu_io_bundleReg_rs2;	// @[cpu/src/TOP.scala:36:26]
  wire [4:0]  _idu_io_bundleReg_rd;	// @[cpu/src/TOP.scala:36:26]
  wire [31:0] _idu_io_imm;	// @[cpu/src/TOP.scala:36:26]
  wire        _idu_io_isEbreak;	// @[cpu/src/TOP.scala:36:26]
  ysyx_23060194_IDU idu (	// @[cpu/src/TOP.scala:36:26]
    .io_inst                      (_ifu_io_inst),	// @[cpu/src/TOP.scala:42:26]
  ...
  ysyx_23060194_WBU wbu (	// @[cpu/src/TOP.scala:37:26]
    .clock            (clock),
    .io_writeEnable   (_controller_io_bundleControlOut_writeEnable),	// @[cpu/src/TOP.scala:39:26]
    .io_isJump        (_controller_io_bundleControlOut_isJump),	// @[cpu/src/TOP.scala:39:26]
    .io_isLoad        (_controller_io_bundleControlOut_isLoad),	// @[cpu/src/TOP.scala:39:26]
    .io_isUnsigned    (_controller_io_bundleControlOut_isUnsigned),	// @[cpu/src/TOP.scala:39:26]
    .io_isContext     (_controller_io_bundleControlOut_isContext),	// @[cpu/src/TOP.scala:39:26]
    .io_imm           (_idu_io_imm),	// @[cpu/src/TOP.scala:36:26]
    .io_csrType       (_controller_io_bundleControlOut_csrType),	// @[cpu/src/TOP.scala:39:26]
    .io_lsuType       (_controller_io_bundleControlOut_lsuType),	// @[cpu/src/TOP.scala:39:26]
    .io_pc            (_ifu_io_pc),	// @[cpu/src/TOP.scala:42:26]
    .io_dataWrite     (_lsu_io_res),	// @[cpu/src/TOP.scala:43:26]
    .io_bundleReg_rs1 (_idu_io_bundleReg_rs1),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleReg_rs2 (_idu_io_bundleReg_rs2),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleReg_rd  (_idu_io_bundleReg_rd),	// @[cpu/src/TOP.scala:36:26]
    .io_lsuStatus     (_lsu_io_status),	// @[cpu/src/TOP.scala:43:26]
    .io_dataRead1     (_wbu_io_dataRead1),
    .io_dataRead2     (_wbu_io_dataRead2),
    .io_csrData       (_wbu_io_csrData),
    .io_resCSR        (_wbu_io_resCSR)
  );
  ysyx_23060194_EXU exu (	// @[cpu/src/TOP.scala:38:26]
    .io_bundleEXControl_isALUSrc   (_controller_io_bundleEXControl_isALUSrc),	// @[cpu/src/TOP.scala:39:26]
    .io_bundleEXControl_isJAL      (_controller_io_bundleEXControl_isJAL),	// @[cpu/src/TOP.scala:39:26]
    .io_bundleEXControl_isBranch   (_controller_io_bundleEXControl_isBranch),	// @[cpu/src/TOP.scala:39:26]
    .io_bundleEXControl_isUnsigned (_controller_io_bundleEXControl_isUnsigned),	// @[cpu/src/TOP.scala:39:26]
    .io_bundleEXControl_aluType    (_controller_io_bundleEXControl_aluType),	// @[cpu/src/TOP.scala:39:26]
    .io_dataRead1                  (_wbu_io_dataRead1),	// @[cpu/src/TOP.scala:37:26]
    .io_dataRead2                  (_wbu_io_dataRead2),	// @[cpu/src/TOP.scala:37:26]
    .io_csrData                    (_wbu_io_csrData),	// @[cpu/src/TOP.scala:37:26]
    .io_imm                        (_idu_io_imm),	// @[cpu/src/TOP.scala:36:26]
    .io_pc                         (_ifu_io_pc),	// @[cpu/src/TOP.scala:42:26]
    .io_ifuStatus                  (_ifu_io_status),	// @[cpu/src/TOP.scala:42:26]
    .io_resBranch                  (_exu_io_resBranch),
    .io_res                        (_exu_io_res),
    .io_out_aw_valid               (_exu_io_out_aw_valid),
    .io_out_w_bits_data            (_exu_io_out_w_bits_data)
  );
  Controller controller (	// @[cpu/src/TOP.scala:39:26]
    .io_bundleControlIn_isALUSrc     (_idu_io_BundleControl_isALUSrc),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isJump       (_idu_io_BundleControl_isJump),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isBranch     (_idu_io_BundleControl_isBranch),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isJAL        (_idu_io_BundleControl_isJAL),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_writeEnable  (_idu_io_BundleControl_writeEnable),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isLoad       (_idu_io_BundleControl_isLoad),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isStore      (_idu_io_BundleControl_isStore),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isUnsigned   (_idu_io_BundleControl_isUnsigned),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_isContext    (_idu_io_BundleControl_isContext),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_csrType      (_idu_io_BundleControl_csrType),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_lsuType      (_idu_io_BundleControl_lsuType),	// @[cpu/src/TOP.scala:36:26]
    .io_bundleControlIn_aluType      (_idu_io_BundleControl_aluType),	// @[cpu/src/TOP.scala:36:26]
  ...
  Trap trap (	// @[cpu/src/TOP.scala:40:26]
    .clock    (clock),
    .reset    (reset),
    .isEbreak (_idu_io_isEbreak)	// @[cpu/src/TOP.scala:36:26]
  );
  GetPC getPC (	// @[cpu/src/TOP.scala:41:26]
    .clock (clock),
    .reset (reset),
    .pc    (_ifu_io_pc)	// @[cpu/src/TOP.scala:42:26]
  );
  ysyx_23060194_IFU ifu (	// @[cpu/src/TOP.scala:42:26]
    .clock               (clock),
    .reset               (reset),
    .io_isJump           (_controller_io_bundleControlOut_isJump),	// @[cpu/src/TOP.scala:39:26]
    .io_isBranch         (_controller_io_bundleControlOut_isBranch),	// @[cpu/src/TOP.scala:39:26]
    .io_resBranch        (_exu_io_resBranch),	// @[cpu/src/TOP.scala:38:26]
    .io_addrTarget       (_lsu_io_res),	// @[cpu/src/TOP.scala:43:26]
    .io_csrType          (_controller_io_bundleControlOut_csrType),	// @[cpu/src/TOP.scala:39:26]
    .io_resCSR           (_wbu_io_resCSR),	// @[cpu/src/TOP.scala:37:26]
    .io_lsuStatus        (_lsu_io_status),	// @[cpu/src/TOP.scala:43:26]
    .io_out_r_bits_data  (_arbiter_io_in2ifu_r_bits_data),	// @[cpu/src/TOP.scala:45:26]
    .io_pc               (_ifu_io_pc),
  ...
  ysyx_23060194_LSU lsu (	// @[cpu/src/TOP.scala:43:26]
    .clock               (clock),
    .reset               (reset),
    .io_isLoad           (_controller_io_bundleControlOut_isLoad),	// @[cpu/src/TOP.scala:39:26]
    .io_isStore          (_controller_io_bundleControlOut_isStore),	// @[cpu/src/TOP.scala:39:26]
    .io_addr             (_exu_io_res),	// @[cpu/src/TOP.scala:38:26]
    .io_len              ({28'h0, _controller_io_bundleControlOut_lsuType}),	// @[cpu/src/TOP.scala:39:26, :58:18]
    .io_in_aw_valid      (_exu_io_out_aw_valid),	// @[cpu/src/TOP.scala:38:26]
    .io_in_w_bits_data   (_exu_io_out_w_bits_data),	// @[cpu/src/TOP.scala:38:26]
    .io_out_r_bits_data  (_arbiter_io_in2lsu_r_bits_data),	// @[cpu/src/TOP.scala:45:26]
    .io_res              (_lsu_io_res),
  ...
  AXI4SRAM sram (	// @[cpu/src/TOP.scala:44:26]
    .clock              (clock),
    .io_in_ar_valid     (_arbiter_io_out_ar_valid),	// @[cpu/src/TOP.scala:45:26]
    .io_in_ar_bits_addr (_arbiter_io_out_ar_bits_addr),	// @[cpu/src/TOP.scala:45:26]
    .io_in_ar_bits_len  (_arbiter_io_out_ar_bits_len),	// @[cpu/src/TOP.scala:45:26]
    .io_in_aw_valid     (_arbiter_io_out_aw_valid),	// @[cpu/src/TOP.scala:45:26]
    .io_in_w_bits_data  (_arbiter_io_out_w_bits_data),	// @[cpu/src/TOP.scala:45:26]
    .io_isIFU           (_ifu_io_isIFU),	// @[cpu/src/TOP.scala:42:26]
    .io_isLSU           (_lsu_io_isLSU),	// @[cpu/src/TOP.scala:43:26]
    .io_resIFU          (_sram_io_resIFU),
    .io_resLSU          (_sram_io_resLSU)
  );
  AXI4Arbiter arbiter (	// @[cpu/src/TOP.scala:45:26]
    .io_in2ifu_ar_valid     (_ifu_io_out_ar_valid),	// @[cpu/src/TOP.scala:42:26]
    .io_in2ifu_ar_bits_addr (_ifu_io_out_ar_bits_addr),	// @[cpu/src/TOP.scala:42:26]
    .io_in2lsu_ar_valid     (_lsu_io_out_ar_valid),	// @[cpu/src/TOP.scala:43:26]
    .io_in2lsu_ar_bits_addr (_lsu_io_out_ar_bits_addr),	// @[cpu/src/TOP.scala:43:26]
    .io_in2lsu_ar_bits_len  (_lsu_io_out_ar_bits_len),	// @[cpu/src/TOP.scala:43:26]
    .io_in2lsu_aw_valid     (_lsu_io_out_aw_valid),	// @[cpu/src/TOP.scala:43:26]
    .io_in2lsu_w_bits_data  (_lsu_io_out_w_bits_data),	// @[cpu/src/TOP.scala:43:26]
    .io_isIFU               (_ifu_io_isIFU),	// @[cpu/src/TOP.scala:42:26]
    .io_isLSU               (_lsu_io_isLSU),	// @[cpu/src/TOP.scala:43:26]
    .io_resIFU              (_sram_io_resIFU),	// @[cpu/src/TOP.scala:44:26]
    .io_resLSU              (_sram_io_resLSU),	// @[cpu/src/TOP.scala:44:26]
  ...
  assign io_master_awvalid = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_awaddr = 32'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_awid = 4'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_awlen = 8'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_master_awsize = 3'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_master_awburst = 2'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_wvalid = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_wdata = 64'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_master_wstrb = 8'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_master_wlast = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_bready = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_arvalid = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_araddr = 32'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_arid = 4'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_arlen = 8'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_master_arsize = 3'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_master_arburst = 2'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_master_rready = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_awready = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_wready = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_bvalid = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_bresp = 2'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_bid = 4'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_arready = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_rvalid = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_rresp = 2'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_rdata = 64'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:32:13]
  assign io_slave_rlast = 1'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
  assign io_slave_rid = 4'h0;	// @[<stdin>:1412:10, cpu/src/TOP.scala:38:26, :42:26, :43:26, :44:26, :45:26]
endmodule
