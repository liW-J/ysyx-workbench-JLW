    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    __Vscope_ysyxSoCFull__asic__cpu__cpu__getPC.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.getPC", "getPC", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_ysyxSoCFull__asic__cpu__cpu__sram__dataSRAM.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.sram.dataSRAM", "dataSRAM", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_ysyxSoCFull__asic__cpu__cpu__sram__instSRAM.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.sram.instSRAM", "instSRAM", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_ysyxSoCFull__asic__cpu__cpu__trap.configure(this, name(), "ysyxSoCFull.asic.cpu.cpu.trap", "trap", -9, VerilatedScope::SCOPE_OTHER);
