...
void VTOP___024root__trace_chg_sub_0(VTOP___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgBit(oldp+41,(vlSelf->TOP__DOT__sram__DOT__state));
        bufp->chgBit(oldp+42,(vlSelf->TOP__DOT__ifu__DOT__state));
        bufp->chgIData(oldp+43,(vlSelf->TOP__DOT__pcReg__DOT__pcReg),32);
        bufp->chgIData(oldp+44,(vlSelf->TOP__DOT__sram__DOT__instSRAM_io_pc_r),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgIData(oldp+45,(vlSelf->TOP__DOT__lsu__DOT___dataSRAM_res),32);
        bufp->chgBit(oldp+46,(vlSelf->TOP__DOT__lsu__DOT__dataSRAM__DOT__load_flag));
        bufp->chgBit(oldp+47,(vlSelf->TOP__DOT__lsu__DOT__dataSRAM__DOT__store_flag));
    }
    bufp->chgBit(oldp+48,(vlSelf->clock));
    bufp->chgBit(oldp+49,(vlSelf->reset));
    bufp->chgIData(oldp+50,(vlSelf->io_inst),32);
    bufp->chgIData(oldp+51,(vlSelf->io_pc),32);
    bufp->chgBit(oldp+52,(vlSelf->io_bundleControl_isALUSrc));
    bufp->chgBit(oldp+53,(vlSelf->io_bundleControl_isJump));
    bufp->chgBit(oldp+54,(vlSelf->io_bundleControl_isBranch));
    bufp->chgBit(oldp+55,(vlSelf->io_bundleControl_isJAL));
    bufp->chgBit(oldp+56,(vlSelf->io_bundleControl_writeEnable));
    bufp->chgBit(oldp+57,(vlSelf->io_bundleControl_isLoad));
    bufp->chgBit(oldp+58,(vlSelf->io_bundleControl_isStore));
    bufp->chgBit(oldp+59,(vlSelf->io_bundleControl_isUnsigned));
    bufp->chgBit(oldp+60,(vlSelf->io_bundleControl_isContext));
    bufp->chgCData(oldp+61,(vlSelf->io_bundleControl_csrType),4);
    bufp->chgCData(oldp+62,(vlSelf->io_bundleControl_lsuType),4);
    bufp->chgCData(oldp+63,(vlSelf->io_bundleControl_aluType),4);
    bufp->chgIData(oldp+64,(vlSelf->io_resEX),32);
    bufp->chgIData(oldp+65,(vlSelf->io_src1),32);
    bufp->chgIData(oldp+66,(vlSelf->io_src2),32);
    bufp->chgCData(oldp+67,(vlSelf->io_rs1),5);
    bufp->chgCData(oldp+68,(vlSelf->io_rs2),5);
    bufp->chgCData(oldp+69,(vlSelf->io_rd),5);
    bufp->chgIData(oldp+70,(vlSelf->io_imm),32);
    bufp->chgBit(oldp+71,(vlSelf->io_resBranch));
    bufp->chgBit(oldp+72,(vlSelf->io_writeEnable));
    bufp->chgIData(oldp+73,(vlSelf->TOP__DOT__gprFile__DOT___csrs_ext_R0_data),32);
    bufp->chgIData(oldp+74,(vlSelf->TOP__DOT__exu__DOT__casez_tmp),32);
    bufp->chgIData(oldp+75,(vlSelf->TOP__DOT__exu__DOT__operand1),32);
    bufp->chgIData(oldp+76,(vlSelf->TOP__DOT__exu__DOT__operand2),32);
    bufp->chgIData(oldp+77,(vlSelf->TOP__DOT___lsu_io_res),32);
    bufp->chgIData(oldp+78,(((1U & ((~ (IData)(vlSelf->io_bundleControl_isContext)) 
                                       ...
                                       : ((3U == (IData)(vlSelf->io_bundleControl_csrType))
                                           ? ((IData)(vlSelf->TOP__DOT__gprFile__DOT___GEN_6)
                                              ...
                                              [0x341U]
                                               : 0U)
                                           : 0U)))),32);
    bufp->chgIData(oldp+79,(vlSelf->TOP__DOT__gprFile__DOT__dataWrite),32);
    bufp->chgIData(oldp+80,(((IData)(vlSelf->TOP__DOT__gprFile__DOT___GEN_4)
                              ? vlSelf->TOP__DOT__gprFile__DOT__csrs_ext__DOT__Memory
                             [0x305U] : 0U)),32);
    bufp->chgIData(oldp+81,(((IData)(vlSelf->TOP__DOT__gprFile__DOT___GEN_6)
                              ? vlSelf->TOP__DOT__gprFile__DOT__csrs_ext__DOT__Memory
                             [0x341U] : 0U)),32);
    bufp->chgBit(oldp+82,(((IData)(vlSelf->TOP__DOT__gprFile__DOT___GEN) 
                           & (IData)(vlSelf->io_bundleControl_isJump))));
    bufp->chgBit(oldp+83,(((~ (IData)(vlSelf->io_bundleControl_isJump)) 
                           & (IData)(vlSelf->TOP__DOT__gprFile__DOT___GEN))));
    bufp->chgBit(oldp+84,(((IData)(vlSelf->TOP__DOT__gprFile__DOT____Vcellinp__csrs_ext__W0_en) 
                           & (0U != (IData)(vlSelf->io_rd)))));
    bufp->chgBit(oldp+85,(((IData)(vlSelf->TOP__DOT__gprFile__DOT____Vcellinp__csrs_ext__W1_en) 
                           & (0U != (IData)(vlSelf->io_rd)))));
    bufp->chgIData(oldp+86,(vlSelf->io_bundleControl_lsuType),32);
}
