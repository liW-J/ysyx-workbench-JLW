...
VL_INLINE_OPT void VTOP___024root___nba_sequent__TOP__3(VTOP___024root* vlSelf) {
    ...
    vlSelf->TOP__DOT__exu__DOT__operand1 = ((IData)(vlSelf->io_bundleControl_isJAL)
                                             ...
                                             : vlSelf->io_src1);
    if ((1U == (IData)(vlSelf->TOP__DOT__ifu__DOT__state))) {
        vlSelf->TOP__DOT__sram__DOT__dataSRAM_io_addr_r 
            = vlSelf->TOP__DOT___arbiter_io_out_ar_bits_addr;
        if (vlSelf->TOP__DOT__arbiter__DOT___GEN_1) {
            vlSelf->TOP__DOT__sram__DOT__dataSRAM_io_len_r = 0U;
            vlSelf->TOP__DOT__sram__DOT__dataSRAM_io_wdata_r = 0U;
        } else {
            vlSelf->TOP__DOT__sram__DOT__dataSRAM_io_len_r 
                = vlSelf->io_bundleControl_lsuType;
            vlSelf->TOP__DOT__sram__DOT__dataSRAM_io_wdata_r 
                = vlSelf->io_src2;
        }
        ...
        vlSelf->TOP__DOT__sram__DOT__dataSRAM_io_isLoad_r 
            = (1U & ((0U == (IData)(vlSelf->TOP__DOT__arbiter__DOT__exec))
                      ? ((~ (IData)((0U != (IData)(vlSelf->TOP__DOT__ifu__DOT__state)))) 
    ...
    vlSelf->io_src2 = vlSelf->TOP__DOT__wbu__DOT__regs_ext__DOT__Memory
        [vlSelf->io_rs2];
    vlSelf->TOP__DOT__ifu__DOT__state = vlSelf->__Vdly__TOP__DOT__ifu__DOT__state;
...
#endif
                    VL_FATAL_MT("/home/sends/local/share/ysyx-workbench/npc/build/TOP.v", 963, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/sends/local/share/ysyx-workbench/npc/build/TOP.v", 963, "", "NBA region did not converge.");
            }
