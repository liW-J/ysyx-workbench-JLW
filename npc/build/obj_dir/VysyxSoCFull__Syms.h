...
class VysyxSoCFull__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope __Vscope_ysyxSoCFull__asic__cpu__cpu__getPC;
    VerilatedScope __Vscope_ysyxSoCFull__asic__cpu__cpu__sram__dataSRAM;
    VerilatedScope __Vscope_ysyxSoCFull__asic__cpu__cpu__sram__instSRAM;
    VerilatedScope __Vscope_ysyxSoCFull__asic__cpu__cpu__trap;
